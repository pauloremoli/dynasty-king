    ...
    <div className="flex flex-col md:flex-row w-full md:my-32 px-4 items-center justify-center relative">
      <div className="flex flex-col h-full w-full">
        ...
        <div className="flex mx-auto flex-col pt-12 md:pt-0">
          ...
          <h1 className="pb-8 text-3xl md:text-6xl font-extrabold tracking-wider text-white first-letter:text-[#ffff00] uppercase">
            King
          </h1>
        </div>
        <p className="pt-4 md:pt-8 text-xl md:text-2xl text-[#caf0f8]">
          Collection of tools that will help you dominate your dynasty
          leagues.
        </p>
      </div>
      <div className="flex w-full h-full items-start justify-start py-12 md:py-0">
